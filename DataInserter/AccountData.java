...
public class AccountData {
	...
	public static void addAddress(String personCode, String street,
			String city, String state, String zip, String country) {
	...
	public static void addProperty(String assetCode, String label, double appraisedValue) {
		//TODO: implement. insert into Generic Asset class like Crypto
	...
	/**
	 * Adds a crypto currency asset corresponding to <code>assetCode</code> (which is 
	...
	/**
	 * Adds a stock asset corresponding to <code>assetCode</code> (which is 
	 * assumed to already exist in the database) to the account corresponding to the 
	 * provided <code>accountNumber</code>.
	 * 
	 * @param accountNumber
	...
	public static void addStockToAccount(String accountNumber, String assetCode, String purchaseDate,
		...
		//TODO: similar to property and crypto insertion
	...
	public static void addStockOptionToAccount(String accountNumber, String assetCode, String purchaseDate, 
			String optionType, String strikeDate, double shareLimit, double premiumPerShare, double strikePricePerShare) {
