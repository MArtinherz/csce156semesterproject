...
public class Option extends Asset implements Value{
	 ...
	 * 
	 * 
	 * This calculates the gain/loss of the option
	 * 
	 * 
	 */
	...
	public String toString() {
		return String.format("Old value of %s %s option: $%f for %f stocks at strike price: %f \n"
				+ "Current Share Price: %f \n"
				+ "Total Value of Investment: %f percent", this.getLabel(), this.getType(), 
